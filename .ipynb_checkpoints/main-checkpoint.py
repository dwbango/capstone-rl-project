...
def main():
    ...
    while shoes_played < config.NUM_SHOES_TO_PLAY and bankroll > 0:
        ...
        try:
            # Pass 'true_count_int' here, but place_wager currently just uses flat bets
        ...
        for i, phand in enumerate(player_hands):
            ...
            logger.log_hand(outcome, final_profit, bankroll, actions_this_hand,
                            starting_true_count, starting_decks_remaining, dealer_actions)
